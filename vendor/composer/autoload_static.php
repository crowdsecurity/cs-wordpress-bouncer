...
class ComposerStaticInit4b873ba8e7b65775adbfceed536a1658
{
    ...
    public static $classMap = array (
        ...
        'CrowdSecBouncer\\StandaloneBouncer' => __DIR__ . '/..' . '/crowdsec/bouncer/src/StandaloneBouncer.php',
        'CrowdSecBouncer\\Template' => __DIR__ . '/..' . '/crowdsec/bouncer/src/Template.php',
        'CrowdSec\\CapiClient\\AbstractClient' => __DIR__ . '/..' . '/crowdsec/capi-client/src/AbstractClient.php',
        'CrowdSec\\CapiClient\\ClientException' => __DIR__ . '/..' . '/crowdsec/capi-client/src/ClientException.php',
        'CrowdSec\\CapiClient\\Configuration\\AbstractConfiguration' => __DIR__ . '/..' . '/crowdsec/capi-client/src/Configuration/AbstractConfiguration.php',
        ...
        'CrowdSec\\CapiClient\\HttpMessage\\AbstractMessage' => __DIR__ . '/..' . '/crowdsec/capi-client/src/HttpMessage/AbstractMessage.php',
        'CrowdSec\\CapiClient\\HttpMessage\\Request' => __DIR__ . '/..' . '/crowdsec/capi-client/src/HttpMessage/Request.php',
        'CrowdSec\\CapiClient\\HttpMessage\\Response' => __DIR__ . '/..' . '/crowdsec/capi-client/src/HttpMessage/Response.php',
        'CrowdSec\\CapiClient\\Logger\\FileLog' => __DIR__ . '/..' . '/crowdsec/capi-client/src/Logger/FileLog.php',
        'CrowdSec\\CapiClient\\RequestHandler\\AbstractRequestHandler' => __DIR__ . '/..' . '/crowdsec/capi-client/src/RequestHandler/AbstractRequestHandler.php',
        'CrowdSec\\CapiClient\\RequestHandler\\Curl' => __DIR__ . '/..' . '/crowdsec/capi-client/src/RequestHandler/Curl.php',
        'CrowdSec\\CapiClient\\RequestHandler\\FileGetContents' => __DIR__ . '/..' . '/crowdsec/capi-client/src/RequestHandler/FileGetContents.php',
        'CrowdSec\\CapiClient\\RequestHandler\\RequestHandlerInterface' => __DIR__ . '/..' . '/crowdsec/capi-client/src/RequestHandler/RequestHandlerInterface.php',
        ...
        'CrowdSec\\LapiClient\\AbstractClient' => __DIR__ . '/..' . '/crowdsec/lapi-client/src/AbstractClient.php',
        ...
        'CrowdSec\\LapiClient\\HttpMessage\\AbstractMessage' => __DIR__ . '/..' . '/crowdsec/lapi-client/src/HttpMessage/AbstractMessage.php',
        'CrowdSec\\LapiClient\\HttpMessage\\Request' => __DIR__ . '/..' . '/crowdsec/lapi-client/src/HttpMessage/Request.php',
        'CrowdSec\\LapiClient\\HttpMessage\\Response' => __DIR__ . '/..' . '/crowdsec/lapi-client/src/HttpMessage/Response.php',
        'CrowdSec\\LapiClient\\Logger\\FileLog' => __DIR__ . '/..' . '/crowdsec/lapi-client/src/Logger/FileLog.php',
        'CrowdSec\\LapiClient\\RequestHandler\\AbstractRequestHandler' => __DIR__ . '/..' . '/crowdsec/lapi-client/src/RequestHandler/AbstractRequestHandler.php',
        'CrowdSec\\LapiClient\\RequestHandler\\Curl' => __DIR__ . '/..' . '/crowdsec/lapi-client/src/RequestHandler/Curl.php',
        'CrowdSec\\LapiClient\\RequestHandler\\FileGetContents' => __DIR__ . '/..' . '/crowdsec/lapi-client/src/RequestHandler/FileGetContents.php',
        'CrowdSec\\LapiClient\\RequestHandler\\RequestHandlerInterface' => __DIR__ . '/..' . '/crowdsec/lapi-client/src/RequestHandler/RequestHandlerInterface.php',
        ...
        'CrowdSec\\RemediationEngine\\Configuration\\AbstractConfiguration' => __DIR__ . '/..' . '/crowdsec/remediation-engine/src/Configuration/AbstractConfiguration.php',
        ...
        'CrowdSec\\RemediationEngine\\Logger\\FileLog' => __DIR__ . '/..' . '/crowdsec/remediation-engine/src/Logger/FileLog.php',
