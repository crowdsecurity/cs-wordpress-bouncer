<div class="wrap">
	...
	<div class="tab-content">
		<div id="tab-1" class="tab-pane active">
			<form method="post" action="<?php echo add_query_arg( 'action', 'crowdsec_theme_settings', 'edit.php' ) ?>">

				<input type="hidden" name="action" value="crowdsec_theme_settings_update"/>
				<input type="hidden" name="nonce" value="<?php echo wp_create_nonce('crowdsec-theme-settings-update');
				?>"/>
				<?php
