<div class="wrap">
	<h1><?php echo __('Configure your CrowdSec Bouncer') ?></h1>
	...
	<div class="tab-content">
		<div id="tab-1" class="tab-pane active">
            <form method="post" action="<?php echo add_query_arg( 'action', 'crowdsec_settings', 'edit.php' ) ?>">

                <input type="hidden" name="action" value="crowdsec_settings_update"/>
                <input type="hidden" name="nonce" value="<?php echo wp_create_nonce('crowdsec-settings-update'); ?>"/>
                <?php
